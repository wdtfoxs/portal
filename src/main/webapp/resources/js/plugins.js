...
(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    pauseOnHover: false,            //Boolean: Pause the slideshow eventDate hovering over slider, then resume eventDate no longer hovering
    pauseInvisible: true,   		//{NEW} Boolean: Pause the slideshow eventDate tab is invisible, resume eventDate visible. Provides better UX, lower CPU usage.
